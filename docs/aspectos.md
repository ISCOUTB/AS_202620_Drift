...
| -- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- | ----------------------------------------- | -------------------------------------------------------------------- | ------------------------------ | ------------------------------------------------------------------------ |
| E1 | Rendimiento    | La consulta de precios debe responder en ≤ 3 segundos en p95 con hasta 50 usuarios concurrentes.                                                     | [C4 nivel 2](c4/contenedores.md)                                | [ADR-0002](adr/0002-arquitectura-base.md) | `backend/app/application/usecases/search_games.py`                   | `backend/tests/test_health.py` | Pendiente de medición de rendimiento.                                    |
| E2 | Mantenibilidad | Se debe poder cambiar una fuente externa sin modificar el dominio ni los demás adaptadores.                                                          | [C4 nivel 2](c4/contenedores.md)                                | [ADR-0002](adr/0002-arquitectura-base.md) | `backend/app/infrastructure/external/steam/steam_game_repository.py` | `backend/tests/test_health.py` | Corte vertical implementado; prueba específica de sustitución pendiente. |
| E3 | Usabilidad     | El usuario debe poder identificar la opción más conveniente en un máximo de 3 interacciones.                                                         | [C4 nivel 1](c4/contexto.md) / [C4 nivel 2](c4/contenedores.md) | [ADR-0002](adr/0002-arquitectura-base.md) | `frontend/ui/components/DriftHome.js`                                | Pendiente                      | Pendiente de evidencia de prueba de usabilidad.                          |
| E4 | Compatibilidad | La consulta de compatibilidad debe responder en ≤ 5 segundos en p95.                                                                                 | [C4 nivel 2](c4/contenedores.md)                                | [ADR-0002](adr/0002-arquitectura-base.md) | Pendiente de implementación                                          | Pendiente                      | Pendiente.                                                               |
| E5 | Disponibilidad | Ante la falla de una fuente externa, el sistema debe continuar mostrando la información disponible de las demás fuentes y responder en ≤ 5 segundos. | [C4 nivel 2](c4/contenedores.md)                                | [ADR-0002](adr/0002-arquitectura-base.md) | `backend/app/infrastructure/external/steam/steam_game_repository.py` | Pendiente                      | Pendiente de prueba específica de tolerancia a fallos.                   |
